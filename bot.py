...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = """👋 Welcome to @Fragmentkyczbot - a fast, secure, and affordable Fragment KYC service trusted by 100+ users. Start now and get verified in minutes. Support: @Fragkyzsupportbot Reviews :
