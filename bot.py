...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = """🥳 Welcome to the @Fragmentkyc_bot - We provide fragment KYC verification services with fast, secure, and professional handling. Get your KYC done perfectly for just $20. Stay updated at Join[https://t.me/+aCgDI5nDudpkZDQ1]."""
